...
@Configuration
@EnableJpaRepositories(basePackages = "blog.benggri.springboot.biz.jpa.repository" , entityManagerFactoryRef = "basicEntityManager", transactionManagerRef = "basicTransactionManager")
public class JpaDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean basicEntityManager() throws SQLException {
        ...
        em.setPackagesToScan("blog.benggri.springboot.biz.jpa.entity");
